...
학원 선생님별 월 지급액을 유형에 맞게 계산하고, 급여명세서와 기장용 급여내역서를 만드는 GitHub Pages + Firebase 웹 앱입니다.
...
- 선생님별 4대보험 가입자·프리랜서 유형과 기본 월 지급액 관리
- 선생님 정보 수정·비활성화와 계정 접근 동시 제어
- 월별 선생님 지급액 입력과 기본 월 지급액 자동 적용
- 수업이 없는 4대보험 가입자의 월급 계산
- 가입자는 근로소득·보험 적용, 프리랜서는 사업소득·보험 미적용 자동 구분
...
- 선생님의 명세서 최초 열람 기록
- 교사·관리자 급여명세서 PDF 다운로드 및 기장용 CSV 출력
