...
- 비율제는 학원 전체 매출이 아니라 **해당 선생님 담당 학생들의 학원비**에 적용합니다. `학생 수 × 1인당 월 학원비`를 금액별로 최대 10개 항목에 입력합니다. 선생님이 제출하거나 비워두고 관리자가 보완할 수 있습니다. 관리자 입력값은 선생님 재제출로 덮어쓰지 않습니다. 미입력과 0명 정산을 구분하고 명세서·CSV에 인원·학원비·비율을 보존합니다.
